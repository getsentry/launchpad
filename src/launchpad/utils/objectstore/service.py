# TODO(EME-): Use published objectstore service when available
...
from launchpad.utils.objectstore.metadata import (
    HEADER_EXPIRATION,
    HEADER_META_PREFIX,
    Compression,
    ExpirationPolicy,
...
from launchpad.utils.objectstore.metrics import measure_storage_operation
...
class ClientBuilder:
    ...
    def _make_client(self, scope: str) -> Client:
        options = self._options or {"base_url": "http://localhost:8888/"}
